    ...
    <div className={styles.container}>
        ...
        <div className={styles.cardlist}>
            <span className={styles.card}>
                ...
                <br />
                <img src="/image/enhanced_quarries.png" alt="Enhanced Quarries スクリーンショット" style={{ maxWidth: '100%', height: 'auto', border: '2px solid #ccc', borderRadius: '4px', marginBottom: '16px' }} />
